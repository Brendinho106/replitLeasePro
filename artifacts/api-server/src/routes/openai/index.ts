...
3. CITATION REQUIREMENT: Every factual statement must be followed by an inline citation using the exact document name from the [Source: ...] label that precedes the relevant snippet. Format it in bold brackets at the end of the sentence, e.g. "Base rent is $35.41/SF **[Penrose III Rent Roll]**" or "The lease expires February 28, 2027 **[Red Gate Third Amendment]**". If a section number or clause title is visible in the snippet, include it before the source tag, e.g. "Per Section 5 (Rent) — base rent is $X **[Red Gate Lease]**". Never state a fact without a citation.
